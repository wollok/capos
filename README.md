...
#### Requerimientos
- Saber los enemigos vencibles de rolando
- Saber las moradas conquistables por rolando
...
Un artefacto fatal es aquel que le da a rolando un poder de pelea superior al poder 
de batalla de su enemigo. Es decir, un artefacto no es fatal por si sólo,
si no se calcula para un enemigo en particular

#### Requerimiento

- Requerimiento: Saber si rolando posee encima un artefacto fatal para enfrentar un enemigo
- Obtener de entre los artefactos que tiene encima rolando, un artefacto fatal para enfrentar a un enemigo

#### Ejemplo

Si rolando tiene de base 15, la espada, la armadura y el collar, entonces cuenta con un artefacto fatal,
